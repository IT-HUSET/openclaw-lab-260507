...
usage() {
  cat >&2 <<'EOF'
Usage:
  ./scripts/native-multi-gateway/dashboard.sh <participant-index>
  ./scripts/native-multi-gateway/dashboard.sh <profile>

Examples:
  ./scripts/native-multi-gateway/dashboard.sh 1
  ./scripts/native-multi-gateway/dashboard.sh p01
EOF
  exit 1
}
